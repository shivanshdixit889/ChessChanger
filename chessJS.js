window.onload = ()=>{
    ...
    function selectMode(){
        ...
        for(var m=0; m<modes.length; m++){
            ...
            modes[m].style.backgroundColor = "rgba(38, 144, 214, 0.4)";
        }
        this.style.backgroundColor = "rgba(38, 158, 214, 1)"; 
        if(this==modes[0]){
            singlePlayer=false;
        }
        else{
    ...
    function updateSquareColor(){
        ...
        for(i=0; i<64; ++i){
            ...
            if(Math.floor(i/8)%2!=0){
                ...
                if(i%2==0){
                        square[i].style.backgroundColor = "rgba(16, 86, 127, 1)";  
                        square[i].style.boxShadow ="none";        
                        square[i].style.borderColor = "rgba(16, 68, 127, 1)";
                    }    
                    //for odd number of column             
                    else{
                        square[i].style.backgroundColor = "rgba(151, 245, 225, 1)";         
                        square[i].style.boxShadow ="none";
                        square[i].style.borderColor = "rgba(151, 223, 245, 1)";
                    }
            }
            //for odd number of rows        
                ...
                //for odd number of column
                if(i%2!=0){
                    square[i].style.backgroundColor = "rgba(16, 77, 127, 1)";          
                    square[i].style.boxShadow ="none";
                    square[i].style.borderColor = "rgba(16, 55, 127, 1)";
                }
                //for even number of column
                else{
                    square[i].style.backgroundColor = "rgba(151, 203, 245, 1)";             
                    square[i].style.boxShadow ="none";                                  
                    square[i].style.borderColor = "rgba(151, 192, 245, 1)";
                }
            }                                                               
        }
    }
    ...
    function updateMovesColor(prev,next){
        ...
        square[prev].style.boxShadow = "inset 0px 0px 40px 10px rgba(255, 0, 0, 1), inset 0px 0px 70px 30px rgba(255, 0, 0, 1), inset 0px 0px 80px 20px #fff";
        square[next].style.boxShadow = "inset 0px 0px 40px 10px rgba(255, 0, 0, 1), inset 0px 0px 70px 30px rgba(255, 0, 0, 1), inset 0px 0px 80px 20px #fff";   
    ...
    function updateScopesColor(){
        for(i=0; i<scopes.length; i++){
            ...
            square[scopes[i]].style.boxShadow = "inset 0px 0px 50px 20px rgba(20, 255, 110, 1), inset 0px 0px 100px 30px #90f39dff";    
